...
<div class="dish-upcoming-menus">
	...
	<article class="dish-menu-entry">
		...
		<?php if ( $_has_dietary || $_has_friendly ) : ?>
			<div class="dish-menu-entry__dietary">
				...
				?>
					<p class="dish-menu-entry__flags">
						...
						<?php echo esc_html( implode( ', ', $_flag_display ) ); ?>
					</p>
				<?php endif; ?>

				<?php if ( $_has_friendly ) :
				...
				?>
					<p class="dish-menu-entry__friendly">
						<?php echo esc_html( implode( '/', $_friendly_display ) . ' ' . __( 'Friendly', 'dish-events' ) ); ?>
					</p>
				<?php endif; ?>
