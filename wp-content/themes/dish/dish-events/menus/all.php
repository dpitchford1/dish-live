...
<div class="dish--menus">
	...
	<div class="split-grid--card">
		...
		<div class="card--content">
            <?php if ( $_next_date ) : ?>
            <p class="card--date txt--sm">Next class: <time datetime="<?php echo esc_attr( DateHelper::format( $_next_date, 'c' ) ); ?>">
                <?php
                /* translators: %s: human-readable date */
                printf( esc_html__( '%s', 'dish-events' ), esc_html( DateHelper::to_display( $_next_date ) ) );
                ?></time></p>
            <?php endif; ?>
            <h3 class="section-title"><a href="<?php echo esc_url( $_template_url ); ?>"><?php echo esc_html( $_template->post_title ); ?></a></h3>
		...
		<?php if ( $_has_dietary || $_has_friendly || $_has_custom_dietary || $_has_custom_friendly ) : ?>
            ...
            ?>
                <p class="dietary--flags"><?php esc_html_e( 'Friendly For:', 'dish-events' ); ?> <em><?php echo esc_html( implode( ' / ', $_friendly_all ) ); ?></em></p>
            <?php endif; ?>
