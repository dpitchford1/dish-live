...
/** Breadcrumb separator — consistent with TitleCore. */
        const SEP = ' - ';
        ...
        public static function maybe_title( $title ) {
                ...
                if ( is_post_type_archive( 'dish_format' ) ) {
                        return implode(
                                self::SEP,
                                [ __( 'Formats', 'dish-events' ), __( 'Classes', 'dish-events' ), $site ]
                        );
                }
                ...
                if ( is_singular( 'dish_format' ) ) {
                        return implode(
                                self::SEP,
                                array_filter( [ get_the_title(), __( 'Formats', 'dish-events' ), __( 'Classes', 'dish-events' ), $site ] )
                        );
                }
