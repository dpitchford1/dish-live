	...
	<main id="primary" class="site-main dish-chef-page">
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'dish-chef' ); ?>>
			...
			<div class="dish-chef-header dish-container">
				...
				<div class="dish-chef-header__body">
				...
				</div><!-- .dish-chef-header__body -->

			</div><!-- .dish-chef-header -->

			<?php if ( get_the_content() ) : ?>
				<div class="dish-chef-bio dish-content dish-container">
					<?php the_content(); ?>
				</div>
			<?php endif; ?>
			...
			<?php if ( ! empty( $upcoming ) ) : ?>
				<section class="dish-chef-upcoming dish-container">
					<h2 class="dish-chef-upcoming__heading">
						<?php
						printf(
