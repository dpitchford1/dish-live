...
<div class="dish-calendar-wrap">
	...
	<?php if ( ! empty( $formats ) ) : ?>
		<nav class="dish-calendar-filters" aria-label="<?php esc_attr_e( 'Filter by format', 'dish-events' ); ?>">
			...
			<button
				type="button"
				class="dish-calendar-filter is-active"
				data-format-id="0"
			>
			...
			?>
				<button
					type="button"
					class="dish-calendar-filter"
					data-format-id="<?php echo esc_attr( $format->ID ); ?>"
					style="--dish-filter-color: <?php echo esc_attr( $color ); ?>;"
				>
	...
	<div id="dish-calendar" class="dish-calendar"></div>
